                    ...
                    <div class="col-12 col-lg-6">
                        <form method="post" action="">
                            <div class="mb-2">
                                ...
                                <input type="text" class="form-control" id="allergyName" name="allergyName" required value="<?php if(isset($_POST['allergyName'])) { echo $_POST['allergyName']; } ?>">
                                <?php
                            ...
                            <div class="mb-2">
                                ...
                                <input type="text" class="form-control" id="caseDescription" name="allergyDescription" required value="<?php if(isset($_POST['allergyDescription'])) { echo $_POST['allergyDescription']; } ?>">
                                <?php
                            ...
                            <button type="submit" name="save" class="btn btn-primary mt-2 mb-3 brand-bg-color" id="addAllergyButton">Add Allergy</button>
                        </form>
                    </div>
                </main>
            </div>
