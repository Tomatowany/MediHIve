                    ...
                    <div class="row d-flex justify-content-center w-75 mx-auto">
                        ...
                        <div class="row d-flex justify-content-center">
                            <button onclick="history.back()"
                                class="btn btn-primary mt-2 mb-3 brand-bg-color col-sm-4 col-md-2 me-4">Cancel</button>
                            <button type="submit" name="save"
                                class="btn btn-primary mt-2 mb-3 brand-bg-color col-sm-4 col-md-2 ms-4"
